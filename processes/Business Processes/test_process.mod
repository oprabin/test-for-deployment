[Ivy]
17B9F661D7AF9E1F 7.5.0 #module
>Proto >Proto Collection #zClass
ts0 test_process Big #zClass
ts0 B #cInfo
ts0 #process
...
>Proto ts0 ts0 test_process #zField
...
ts0 f3 dialogId test.fo.test_dialog #txt
ts0 f3 startMethod start(test.fo.Data) #txt
ts0 f3 requestActionDecl '<test.fo.Data data> param;' #txt
