...
ts0 f0 guid 17B9F81753EFD25A #txt
ts0 f0 method start(test.fo.Data) #txt
ts0 f0 inParameterDecl '<test.fo.Data data> param;' #txt
ts0 f0 inParameterMapAction 'out.data=param.data;
' #txt
ts0 f0 outParameterDecl '<test.fo.Data data> result;' #txt
...
ts0 f3 guid 17B9F8175C92A5FF #txt
...
>Proto ts0 .type test.fo.test_dialog.test_dialogData #txt
